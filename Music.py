...
# Music.Note is aligned with MIDI.Note, except that Music doesn't assume notes are limited to 0..127
Note_C0      = 12
Note_A440    = 57
Note_MiddleC = 60 # C4
Note_C7      = 96
...
def intervalClassicalConsonance( note1, note2 ):
    interval = math.abs(note2 - note1) % 12
